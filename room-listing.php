...
<title>I-Rent Portal | Room Listing</title>
<!--Bootstrap -->
...
<?php $sql = "SELECT tblhouse.*,tbllocation.LocationName,tbllocation.id as bid  from tblhouse join tbllocation on tbllocation.id=tblhouse.HouseLocation";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->HouseCapacity);?> seats</li>
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ContractYear);?> model</li>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Find Your Rental </h5>
          </div>
          <div class="sidebar_filter">
            <form action="search-room-result.php" method="post">
...
<option value="Unfurnished">Unfurnished</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-bed" aria-hidden="true"></i> Recently Listed Room</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="house-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>

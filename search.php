...
<title>I-Rent Portal | Listing</title>
<!--Bootstrap -->
...
$sql = "SELECT tblhouse.id from tblhouse 
join tbllocation on tbllocation.id=tblhouse.HouseLocation 
where tblhouse.HouseTitle=:search || tblhouse.FurnishingType=:search || tbllocation.LocationName=:search || tblhouse.ContractYear=:search|| tblhouse.HouseCapacity=:search";
...
<?php 
$sql = "SELECT tblhouse.*,tbllocation.LocationName,tbllocation.id as bid  from tblhouse 
join tbllocation on tbllocation.id=tblhouse.HouseLocation 
where tblhouse.HouseTitle=:search || tblhouse.FurnishingType=:search || tbllocation.LocationName=:search || tblhouse.ContractYear=:search || tblhouse.HouseCapacity=:search";
$query = $dbh -> prepare($sql);
$query -> bindParam(':search',$searchdata, PDO::PARAM_STR);
